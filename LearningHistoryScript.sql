...
INSERT INTO	FACTCourses (CourseName, DateCompleted, SubjectID, LearningPathID, LearningPlatformID, InstructorID, CourseDurationMinutes, MyTimeEstMultiplier)
VALUES
  
('Foundations: Data, Data, Everywhere', CAST('2021-09-17' AS DATE), 21, 6, 'Co', 1, 1320, 0.6),
('Ask Questions to Make Data-Driven Decisions', CAST('2022-03-22' AS DATE), 21, 6, 'Co', 27, 1260, 0.8),
('Prepare Data for Exploration', CAST('2022-04-01' AS DATE), 22, 6, 'Co', 29, 1500, 0.8),
('Process Data from Dirty to Clean', CAST('2022-04-09' AS DATE), 22, 6, 'Co', 28, 1440, 0.8),
('Analyze Data to Answer Questions', CAST('2022-04-13' AS DATE), 22, 6, 'Co', 30, 1560, 0.8),
('Share Data Through the Art of Visualization', CAST('2022-04-24' AS DATE), 20, 6, 'Co', 31, 1440, 1.0),
('Data Analysis with R Programming', CAST('2022-05-06' AS DATE), 18, 6, 'Co', 32, 2220, 1.0),
('Google Data Analytics Capstone: Complete a Case Study', CAST('2022-06-30' AS DATE), 19, 6, 'Co', 26, 540, 1.0),
('Instructional Design: Creating Video Training', CAST('2020-11-07' AS DATE), 1, 0, 'LL', 4, 71, 1.0),
('Agile Foundations', CAST('2021-07-13' AS DATE), 2, 3, 'LL', 5, 95, 1.0),
('Transitioning from Waterfall to Agile Project Management', CAST('2021-07-15' AS DATE), 2, 3, 'LL', 6, 40, 1.0),
('Certification Prep: SHRM-CP', CAST('2022-10-30' AS DATE), 3, 0, 'LL', 7, 152, 1.0),
('QuickBooks Payroll Essential Training', CAST('2022-04-15' AS DATE), 4, 0, 'LL', 8, 85, 1.0),
('Human Resources: Running Company Onboarding', CAST('2022-04-04' AS DATE), 5, 0, 'LL', 9, 42, 1.0),
('Microsoft SQL Server 2019 Essential Training', CAST('2022-05-20' AS DATE), 6, 0, 'LL', 10, 264, 1.2),
('SQL Server: Reporting Services', CAST('2022-05-25' AS DATE), 7, 0, 'LL', 10, 210, 1.2),
('Querying Microsoft SQL Server 2019', CAST('2022-05-22' AS DATE), 6, 0, 'LL', 10, 161, 1.4),
('Power BI Essential Training', CAST('2022-07-11' AS DATE), 10, 0, 'LL', 11, 204, 1.0),
('Implementing a Data Warehouse SQL Server 2019', CAST('2022-08-20' AS DATE), 6, 0, 'LL', 10, 127, 1.2),
('Visio 2019 Essential Training', CAST('2022-09-12' AS DATE), 9, 0, 'LL', 12, 82, 1.0),
('Advanced Microsoft Power BI', CAST('2022-10-02' AS DATE), 10, 1, 'LL', 14, 193, 2.0),
('Excel Essential Training (Office 365/Microsoft 365)', CAST('2022-10-02' AS DATE), 11, 2, 'LL', 13, 137, 1.0),
('Learning Microsoft Project', CAST('2022-09-11' AS DATE), 12, 0, 'LL', 8, 55, 1.0),
('Power BI Data Modeling with DAX', CAST('2022-08-04' AS DATE), 10, 1, 'LL', 11, 82, 1.7),
('Power BI Data Methods', CAST('2022-08-09' AS DATE), 10, 1, 'LL', 14, 236, 1.4),
('Power BI Dataflows Essential Training', CAST('2022-08-10' AS DATE), 10, 1, 'LL', 14, 88, 1.3),
('Power BI Top Skills', CAST('2022-08-18' AS DATE), 10, 1, 'LL', 15, 60, 1.0),
('Power BI: Integrating AI and Machine Learning', CAST('2022-10-18' AS DATE), 10, 1, 'LL', 14, 238, 2.2),
('Cert Prep: Excel Expert - Microsoft Office Specialist for Office 2019 and Office 365', CAST('2022-06-29' AS DATE), 11, 2, 'LL', 16, 283, 1.0),
('Excel: PivotTables in Depth', CAST('2022-08-11' AS DATE), 11, 2, 'LL', 17, 230, 1.0),
('Cert Prep: Excel Associate - Microsoft Office Specialist for Office 2019 and Office 365', CAST('2022-10-20' AS DATE), 11, 2, 'LL', 16, 214, 0.8),
('Power BI: Dashboards for Beginners', CAST('2022-10-24' AS DATE), 8, 7, 'LL', 18, 33, 0.7),
('Power BI Data Visualization and Dashboard Tips, Tricks, & Techniques', CAST('2022-10-24' AS DATE), 8, 7, 'LL', 24, 119, 1.0),
('Excel: Advanced Formulas and Functions', CAST('2022-01-31' AS DATE), 11, 2, 'LL', 13, 287, 2.5),
('Excel Statistics Essential Training: 1', CAST('2022-10-19' AS DATE), 11, 4, 'LL', 19, 217, 1.2),
('Excel: Creating a Basic Dashboard', CAST('2022-10-17' AS DATE), 13, 2, 'LL', 17, 66, 0.5),
('Cert Prep: Scrum Master', CAST('2022-10-15' AS DATE), 14, 3, 'LL', 6, 86, 1.2),
('People Analytics', CAST('2022-02-18' AS DATE), 3, 0, 'LL', 21, 35, 1.0),
('Python Essential Training', CAST('2022-10-31' AS DATE), 15, 0, 'LL', 22, 277, 1.5),
('Excel: Advanced Formatting Techniques', CAST('2022-10-31' AS DATE), 13, 2, 'LL', 25, 162, 0.9),
('Advanced SQL: Logical Query Processing, Part 1', CAST('2022-10-30' AS DATE), 6, 9, 'LL', 23, 98, 1.2),
('Agile Project Management with Jira Cloud: 1 Projects, Boards, and Issues', CAST('2022-10-27' AS DATE), 16, 0, 'LL', 20, 73, 1.0),
('Object-Oriented Data Structures in C++', CAST('2022-07-25' AS DATE), 17, 10, 'Co', 3, 1260, 1.0),
('Excel: Charts in Depth', CAST('2022-11-01' AS DATE), 13, 2, 'LL', 13, 165, 1.0),
('Agile Requirements Foundations', CAST('2022-11-01' AS DATE), 2, 3, 'LL', 33, 103, 1.2),
('Learning ITIL', CAST('2022-11-03' AS DATE), 23, 0, 'LL', 34, 79, 1.3),
('Data Dashboards in Power BI', CAST('2022-11-07' AS DATE), 8, 7, 'LL', 14, 292, 1.1);
